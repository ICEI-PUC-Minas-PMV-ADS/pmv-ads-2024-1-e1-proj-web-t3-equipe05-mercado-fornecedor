...
| Passos | 1. Realizar login com um usuário do tipo fornecedor<br/> Sugestão de fornecedores:<br/>
E-mail: contato@tecnobits.com<br/> Senha: 123456<br />E-mail: contato@escrita.com<br/> Senha: 123456<br /> 2. Acessar a página de pedidos disponíveis da aplicação<br/> 3. Verificar se todos os pedidos estão sendo listados corretamente<br/> 5. Verificar se os detalhes do pedido estão sendo exibidos ao clicar no botão "ver mais"<br/> 6. Verificar a exibição da lista em resoluções menores<br/> 7. Enviar uma cotação através do botão "Enviar cotação"<br/> 8. Verificar se a cotação é listada corretamente no pedido selecionado|
